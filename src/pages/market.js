...
<div class="min-h-screen bg-white md:mt-1">
  ...
  <div class="relative  juice3">
    <div class="max-w-screen-lg mx-auto grid grid-cols-1 sm:grid-cols-12">
      ...
      <div class="col-span-7 p-10">
        ...
        <p class="text-sm text-gray-700 my-4">우리 마을은 <span class="highlight1">해발400m</span> 정도의 산골입니다. 양파농민은 준고량지인데다가 풍토 덕에 양파가 좋다지만, <span class="highlight1">재배방식</span>이 훌륭해서 <span class="highlight1">차돌멩이 양파</span>를 보내드릴 수 있다고 덤바우 부부는 믿습니다.</p>
        <div class="flex items-center">
      
      <div class="text-sm">
        <a href="/website/" class="mt-20 bg-amber-600 px-8 py-2 rounded text-white hover:text-black hover:bg-white disabled-link">주문하기</a>
      </div>
    </div>
      </div>
    </div>
...
<div class="max-w-screen-xl mx-auto p-5 sm:p-10 md:p-10">
  ...
  <div class="border-b mb-5 flex justify-between text-sm">
    <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
      <svg class="h-6 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0" y="0" viewBox="0 0 455.005 455.005">
      <g>
      ...
      <span class="font-semibold text-base inline-block text-gray-500 ps">철따라 이웃따라</span>
    </div>
    <a href="#"></a>
  </div>
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
    ...
    <div class="rounded overflow-hidden shadow-lg flex flex-col juice3">
  <a href="#"><div class="relative">
    <img class="w-full" src="http://jinbasil.com/img/bok-01.jpg" alt="복숭아" />
<div class="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
    <a href="#!"><div class="text-xs absolute top-0 right-0 hover:text-black hover:text-amber-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white transition duration-500 ease-in-out bg-amber-600">
    주문하기
    </div></a>
    </div></a>
  ...
  <div class="px-6 py-3 flex flex-row items-center justify-between border-t-2">
    <span href="#" class="py-1 text-xs font-regular text-gray-900 mr-1 flex flex-row items-center">
      <svg height="13px" width="13px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0"
	 viewBox="0 0 512 512">
<g>
	<g>
...
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path>
    ...
    <div class="rounded overflow-hidden shadow-lg flex flex-col juice3">
  <a href="#"><div class="relative">
    <img class="w-full" src="http://jinbasil.com/img/ja-01.jpg" alt="자두" />
<div class="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
    <a href="#!"><div class="text-xs absolute top-0 right-0 bg-amber-600 px-4 py-2 text-white mt-3 mr-3 hover:text-black hover:bg-white hover:text-amber-600 transition duration-500 ease-in-out">
    주문하기
    </div></a>
    </div></a>
  <div class="px-6 py-4 mb-auto">
    <a href="#" class="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">Best FastFood Ideas (Yummy)</a>
    <p class="text-gray-500 text-sm">
      Lorem Ipsum is simply dummy text of the printing and typesetting industry.
    </p>
  </div>
...
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path>
    ...
    <div class="rounded overflow-hidden shadow-lg flex flex-col juice3">
  <a href="#"><div class="relative">
    <img class="w-full" src="http://jinbasil.com/img/po-01.jpg" alt="샤인 머스켓" />
<div class="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
    <a href="#!"><div class="text-xs absolute top-0 right-0 hover:text-black hover:text-amber-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white transition duration-500 ease-in-out bg-amber-600">
    주문하기
    </div></a>
  ...
  <div class="px-6 py-4 mb-auto">
    <a href="#" class="font-medium text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out inline-block mb-2">Why to eat salad?</a>
    <p class="text-gray-500 text-sm">
      Lorem Ipsum is simply dummy text of the printing and typesetting industry.
    </p>
  </div>
