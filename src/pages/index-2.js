 ...
 <div class="max-w-screen-2xl mx-auto p-5 sm:p-10 relative">
    ...
    <div class="bg-white">
      <div class="grid grid-cols-12 grid-rows-2 sm:grid-rows-1">              
        <div class="col-span-12 sm:col-span-6 relative w-full flex items-end justify-start text-left bg-cover bg-center mbg1-1">
  <div class="absolute top-0 mt-20 right-0 bottom-0 left-0 bg-gradient-to-b from-transparent to-gray-900"></div>
      <div class="absolute top-0 right-0 left-0 mx-10 mt-6 flex justify-between items-center">
        <a href="#" class="text-sm bg-yellow-800 text-white px-5 py-0 uppercase hover:bg-white hover:text-indigo-600 transition ease-in-out duration-500 ps">덤바우</a>
  ...
  <main class="p-10 z-10">
    ...
    <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
      <svg class="h-6 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" x="0" y="0" 
    ...
    <a href="#">See All</a>
          ...
          <div class="flex flex-col justify-between pb-5">
            ...
            <div class="flex items-start justify-between mt-3">
              ...
              <a href="#" class="inline-block ml-2"><div class="w-20 h-20 bg-cover bg-center  juice "></div></a>
            </div>
          ...
          <div class="flex flex-col justify-between pb-5">
            ...
            <div class="flex items-start justify-between mt-3">
              ...
              <a href="#" class="inline-block ml-2"><div class="w-20 h-20 bg-cover bg-center   mbg1-3"></div></a>
            </div>
          ...
          <div class="flex flex-col justify-between pb-5">
            ...
            <div class="flex items-start justify-between mt-3">
              ...
              <a href="#" class="inline-block ml-2"><div class="w-20 h-20 bg-cover bg-center   juice2"></div></a>
            </div>
        ...
        <div class="col-span-12 lg:col-span-3 bg-white border shadow-lg p-6">
          <div class="border-b mb-5 flex justify-between text-sm">
    <div class="text-indigo-600 flex items-center pb-2 pr-2 border-b-2 border-indigo-600 uppercase">
      <svg class="h-6 mr-3" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"  x="0px" y="0px" 
	  viewBox="0 0 455.005 455.005">
      <g>
        <path d="M446.158,267.615c-5.622-3.103-12.756-2.421-19.574,1.871l-125.947,79.309c-3.505,2.208-4.557,6.838-2.35,10.343
          c2.208,3.505,6.838,4.557,10.343,2.35l125.947-79.309c2.66-1.675,4.116-1.552,4.331-1.432c0.218,0.12,1.096,1.285,1.096,4.428
    ...
    <a href="#">See All</a>
          ...
          <div class="grid grid-cols-2 lg:grid-cols-1 gap-5">
            ...
            <a href="#"><div class="h-48 bg-cover text-center overflow-hidden   mbg1-5" title="Woman holding a mug">
            </div></a>
          <a href="#" class="text-gray-900 text-md font-medium inline-block mt-2 hover:text-indigo-600 transition duration-500 ease-in-out">0The perfect summer sweater that you can wear! </a>
          </div>
          <div class="">
            <a href="#"><div class="h-48 bg-cover text-center overflow-hidden   mbg1-6" title="Woman holding a mug">
            </div></a>
          <a href="#" class="text-gray-900 text-md font-medium inline-block mt-2 hover:text-indigo-600 transition duration-500 ease-in-out">ooThe perfect summer sweater that you can wear! </a>
          </div>
          </div>
        </div>
      </div>
