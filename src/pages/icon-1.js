...
<div class="flex space-x-4">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="far" data-icon="arrow-alt-circle-down" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sliders-h" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="basketball-ball" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="brain" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="signal" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="graduation-cap" class="w-8 h-8" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="sort-alpha-up" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="at" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
  ...
  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="certificate" class="w-7 h-7" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
