...
<div class="min-h-screen bg-white md:mt-1">
  ...
  <main>
  <div class="sm:flex items-center max-w-screen md:p-20">
    <div class="sm:w-1/2 p-5 juice3">
        <div class="text">
            <h2 class="my-4 font-bold text-3xl  sm:text-4xl">About <span class="text-indigo-600">Our Company</span></h2><div class="w-24 "></div>
            <p class="text-gray-700 highlight1">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid, commodi doloremque, </p>
        </div>
    </div>
	
	    <div class="sm:w-1/2 p-5">
        <div class="text">
<img class="w-full" src="http://jinbasil.com/img/to-1-1.jpg" alt="Sunset in the mountains" />        </div>
    </div>
...
<div class="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
    <a href="#!"><div class="text-xs absolute top-0 right-0 bg-indigo-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
    Cooking
    </div></a>
    </div></a>
...
<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h4m1 8l-4-4H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-3l-4 4z"></path>
  ...
  <a href="#"><div class="relative">
    <img class="w-full" src="https://images.pexels.com/photos/1600727/pexels-photo-1600727.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Sunset in the mountains" />
<div class="hover:bg-transparent transition duration-300 absolute bottom-0 top-0 right-0 left-0 bg-gray-900 opacity-25"></div>
    <a href="#!"><div class="text-xs absolute top-0 right-0 bg-indigo-600 px-4 py-2 text-white mt-3 mr-3 hover:bg-white hover:text-indigo-600 transition duration-500 ease-in-out">
    Cooking
    </div></a>
